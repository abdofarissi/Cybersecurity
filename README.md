...
**
|
 Military-grade symmetric encryption via Python's 
`cryptography`
...
**
|
 Memory-hard, GPU-resistant password hashing (time_cost=3, memory=64MB, parallelism=2) 
|
|
 🔏 
**
...
**
|
 Streaming hash-based message authentication to detect tampering or corruption 
|
|
 📂 
**
...
**
|
 Encrypt and decrypt any file type — documents, images, archives, and more 
|
|
 🧵 
**
...
**
|
 Background threading keeps the UI responsive during heavy cryptographic operations 
|
|
 💾 
**
...
**
|
 Processes files in 64KB chunks to prevent RAM overflow on large files 
|
|
 🎨 
**
...
**
|
 Sleek CustomTkinter interface with dark mode and intuitive layout 
|
|
 📦 
**
...
**
|
 PyInstaller-ready — build a single 
`.exe`
 for distribution 
|
---
...
|
 AES-256 Fernet encryption/decryption 
|
|
[
**
